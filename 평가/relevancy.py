...
def run_evaluation_custom_relevancy_only():
    ...
    모든 실행이 끝난 후 10회 평균 점수를 '하나의 요약 파일'로 저장
    """
    ...
    # ★ 요청사항: "각 단계별 평균 넣어줘" -> summary_df에 이미 포함됨
